...
meets your requirements. They are organized by [**Requirements**](/docs/requirements): requirements
...
You can add an existing metric to a requirement by clicking the "+" icon in the top-right corner of the chip on the Metrics Overview page.
...
- Assign metrics to [requirements](/docs/requirements) and use them in [test generation](/docs/test-sets/tests-generation)
