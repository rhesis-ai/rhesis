"""
Base target interface for testing agents.

A Target represents any system that a testing agent (Penelope, Architect,
or custom agents) can interact with.  This is the canonical location of
...
class Target(ABC):
    ...
    A Target represents any system that can be tested through interaction.
    Targets must support sending messages and receiving responses, enabling
    ...
    def get_tool_documentation(self) -> str:
        ...
        This is used to help testing agents understand how to use the target.
