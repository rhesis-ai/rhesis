...
| [Requirement](/sdk/entities/test-attributes#requirement) | Expected requirements with associated metrics |
...
| [Prompt](/sdk/entities/test-sets#prompt) | The input of a single-turn test, and its expected response |
...
| [Annotation](/sdk/entities/annotations) | Human verdicts on test results, traces and tests |
| [Trace](/sdk/entities/traces) | What an instrumented application did to serve one request |
| [Span](/sdk/entities/traces#spans-on-their-own) | One operation inside a trace |
| [Experiment](/sdk/entities/experiments) | Named bundles of parameter values, versioned per save |
| [File](/sdk/entities/files) | Binary attachments on tests and test results |
