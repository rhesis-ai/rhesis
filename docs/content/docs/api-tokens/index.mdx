...
<ThemeAwareImage
  lightSrc="/screenshots/rhesis-ai-tokens.webp"
  darkSrc="/screenshots/rhesis-ai-tokens-dark.webp"
  alt="API Tokens page — each token's name, obfuscated value, last use and expiry"
/>
