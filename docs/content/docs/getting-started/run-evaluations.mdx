...
<Callout type="info">
  **Prefer working from your IDE?** The [Rhesis agent skill](/docs/agent-skill) lets you run the full discover-plan-execute workflow — or build a test foundation from your PRD — from Cursor, Claude Code, or any compatible AI interface.
</Callout>
