...
<div style={{ display: "flex", justifyContent: "center" }}>
  <img src="/screenshots/rhesis-ai-multimodal-playground.png" alt="Attaching files in the playground" style={{ border: "2px solid var(--rhesis-primary-dark)", borderRadius: "8px", width: "60%" }} />
</div>
...
<div style={{ display: "flex", justifyContent: "center" }}>
  <img src="/screenshots/rhesis-ai-multimodal-trace.png" alt="Files in conversation trace" style={{ border: "2px solid var(--rhesis-primary-dark)", borderRadius: "8px", width: "60%" }} />
</div>
