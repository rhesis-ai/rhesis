...
<CodeBlock filename="echo-response.json" language="json">
  {`{
  "message": "ping",
  "session_id": "2b52a8cf-7d63-4f8f-8b48-7a43f55d2f4a",
  "context": [],
  "metadata": {
    "use_case": "echo",
    "mode": "text"
...
- `use_case` (string, optional): The domain context. Defaults to "travel"
...
The default chatbot is a parameter-aware endpoint. It uses **[Parameters & Experiments](/docs/parameters)** to manage its system prompt, use case, model, temperature, and output mode. 
...
Learn more about creating custom endpoints in the [Endpoints documentation](/docs/endpoints).
...
<Callout type="default">
  **Next Steps** - Try the [interactive demo](/demo) to chat with Rosalind in
  your browser - Learn about [custom endpoints](/docs/endpoints) for
  your own AI services - Explore [test
  generation](/docs/tests-generation) to validate your AI applications
  - Set up [metrics](/docs/metrics) to measure response quality
</Callout>
