...
<Tabs items={['Environment Variables', 'Direct Configuration']}>
  <Tabs.Tab>
    ```bash export RHESIS_API_KEY="your-api-key" export RHESIS_BASE_URL="https://api.rhesis.ai" ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```python import rhesis rhesis.api_key = "your-api-key" rhesis.base_url =
    "https://api.rhesis.ai" # optional ```
  </Tabs.Tab>
</Tabs>
