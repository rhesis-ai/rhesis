...
<Callout type="info">
  **Complete Schema**: See the [Penelope GitHub repository](https://github.com/rhesis-ai/rhesis/tree/main/penelope) for the complete TestResult schema definition and examples.
</Callout>
