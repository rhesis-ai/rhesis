...
export default function EndpointDetail({
                ...
                <>
                  ...
                  {endpoint.endpoint_metadata.sdk_connection?.function_name && (
                    <Grid size={{ xs: 12, md: 6 }}>
                      ...
                      >
                        {
                          endpoint.endpoint_metadata.sdk_connection
                            .function_name
                        }
                      </Typography>
                    </Grid>
            ...
            {endpoint.connection_type !== 'SDK' && (
              <Grid size={12}>
                ...
                <Typography
                  ...
                  sx={{ mb: 2 }}
                >
                  Custom headers for your endpoint. Authorization and
                  Content-Type are automatically provided. Example:{' '}
                  <code>{`{
  ...
  "x-custom-header": "value"
        ...
        <TabPanel
          value={currentTab}
          index={endpoint.connection_type === 'SDK' ? 3 : 2}
        >
          <Grid container spacing={2}>
            <Grid size={12}>
              <Typography variant="subtitle2" sx={{ mb: 1 }}>
        ...
        <TabPanel
          value={currentTab}
          index={endpoint.connection_type === 'SDK' ? 4 : 3}
        >
          <Grid container spacing={2}>
            <Grid size={12}>
              <Typography variant="subtitle2" sx={{ mb: 1 }}>
