...
When using Custom Mapping with REST Endpoints (Approach 1), Rhesis requires you to map your application's request and response structures to a set of standardized **platform-managed variables**.
