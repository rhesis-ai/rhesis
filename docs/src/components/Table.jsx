...
export const Table = ({
  ...
  const styles = {
    ...
    caption: {
      ...
      borderBottom: '1px solid var(--table-border, var(--rh-border))',
    },
    thead: {
      backgroundColor: 'var(--table-header-bg, var(--rh-surface-alt))',
      borderBottom: '2px solid var(--table-border-dark, var(--rh-border-strong))',
    },
    th: {
    ...
    code: {
      backgroundColor: 'var(--code-bg, var(--rh-surface-sunken))',
      color: 'var(--code-text, var(--rh-blue-cta))',
