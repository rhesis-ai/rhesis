...
1. Open the [Test Sets page](https://app.rhesis.ai/test-sets) and click **Import from File**.
...
| `metadata` | No | Arbitrary structured data stored alongside the test |
...
<Callout type="default">
  **Next Steps**
  - [Execute the test set](/platform/test-sets) to run your imported tests against an endpoint
  - Learn about [Test Types](/platform/test-sets) to understand Single-Turn vs Multi-Turn testing
  - Configure [Metrics](/platform/metrics) to evaluate response quality
</Callout>
