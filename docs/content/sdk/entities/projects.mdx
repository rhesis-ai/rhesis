...
Projects represent the top-level organizational unit in Rhesis. They contain test sets, endpoints, and other resources for testing and evaluating LLM applications.
