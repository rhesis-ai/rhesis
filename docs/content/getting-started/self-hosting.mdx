...
**Learn More**: For technical details about the telemetry architecture, see [Telemetry System Documentation](https://docs.rhesis.ai/development/telemetry).
</Callout>
...
For local development setup without Docker (for contributing to Rhesis), see the 🔧 [Environment Setup Guide](https://docs.rhesis.ai/development/environment-setup).
