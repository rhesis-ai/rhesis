...
class TestQueryBuilder:
    ...
    def test_query_builder_with_joinedloads(self, test_db: Session, authenticated_user_id, test_org_id):
        ...
        with patch('rhesis.backend.app.utils.model_utils.apply_joinedloads') as mock_apply_joinedloads:
            ...
            mock_apply_joinedloads.assert_called_once_with(
                ANY, models.Test, True, False
            )

    def test_query_builder_with_optimized_loads(self, test_db: Session, authenticated_user_id, test_org_id):
        """Test QueryBuilder with_optimized_loads method."""
        # Create QueryBuilder instance
        query_builder = QueryBuilder(test_db, models.Test)
        
        # Mock the apply_optimized_loads function
        with patch('rhesis.backend.app.utils.model_utils.apply_optimized_loads') as mock_apply_optimized_loads:
            mock_modified_query = MagicMock()
    ...
    def test_query_builder_chaining(self, test_db: Session, authenticated_user_id, test_org_id):
        ...
        with patch('rhesis.backend.app.utils.model_utils.apply_joinedloads') as mock_apply_joinedloads, \
             patch('rhesis.backend.app.utils.model_utils.apply_optimized_loads') as mock_apply_optimized_loads:
            ...
            result = (query_builder
                     .with_joinedloads(skip_many_to_many=True)
    ...
    def test_query_builder_state_isolation(self, test_db: Session, authenticated_user_id, test_org_id):
    ...
    def test_query_builder_attributes_initialized(self, test_db: Session, authenticated_user_id, test_org_id):
