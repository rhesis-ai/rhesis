"""
Unit tests for get_execution_model_with_override and get_evaluation_model_with_override
in user_model_utils.

Verifies the per-request model_id override logic:
- When model_id is None, delegates to the user default function
...
@pytest.mark.unit
class TestGetExecutionModelWithOverride:
    """Tests for the execution model_id override branching logic."""

    @patch("rhesis.backend.app.utils.user_model_utils.get_user_execution_model")
    def test_no_override_delegates_to_user_default(
        ...
        result = get_execution_model_with_override(mock_db, mock_user, model_id=None)
    ...
    def test_override_calls_fetch_and_configure(
        ...
        result = get_execution_model_with_override(
    ...
    def test_empty_string_model_id_delegates_to_default(
        ...
        result = get_execution_model_with_override(mock_db, mock_user, model_id="")
...
@pytest.mark.unit
class TestGetEvaluationModelWithOverride:
    """Tests for the evaluation model_id override branching logic."""

    @patch("rhesis.backend.app.utils.user_model_utils.get_user_evaluation_model")
    def test_no_override_delegates_to_user_default(
        self, mock_get_user_model, mock_db, mock_user
    ):
        from rhesis.backend.app.utils.user_model_utils import (
        ...
        result = get_evaluation_model_with_override(mock_db, mock_user, model_id=None)
    ...
    def test_override_calls_fetch_and_configure(
        ...
        result = get_evaluation_model_with_override(
            mock_db, mock_user, model_id="model-789"
        )
    ...
    def test_empty_string_model_id_delegates_to_default(
        ...
        result = get_evaluation_model_with_override(mock_db, mock_user, model_id="")
