...
class TestSingleTurnOutput:
    ...
    async def test_invokes_endpoint_and_returns_output(self):
        ...
        with (
            ...
            patch(
                "rhesis.backend.jobs.execution.executors.output_providers.process_endpoint_result",
...
class TestSingleTurnOutputParamsInjection:
    ...
    async def test_loads_params_from_test_run_when_not_provided(self):
        ...
        with (
            ...
            patch(
                "rhesis.backend.jobs.execution.executors.output_providers._load_run_params",
...
class TestTestResultOutput:
    ...
    async def test_loads_stored_output(self):
        ...
        with patch(
            "rhesis.backend.jobs.execution.executors.output_providers.test_result_crud.get_test_results",
...
class TestTraceOutput:
    ...
    async def test_raises_when_no_traces(self):
        ...
        with patch(
            "rhesis.backend.jobs.execution.executors.output_providers.get_trace_by_id",
            return_value=[],
        ):
