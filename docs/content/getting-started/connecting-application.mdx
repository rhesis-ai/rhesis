...
When creating a REST Endpoint, you'll need to define the mapping either automatically (via Auto-Configure) or manually. Manual mapping requires you to link your application's request and response structures to a set of standardized **platform-managed variables**.

Rhesis uses these variables to pass inputs to your API during testing and extract the outputs for evaluation.
