...
def create_type_lookup_data(**overrides):
    ...
    data = {
        "type_name": "TestType",
        "type_value": fake.word() + "_" + fake.word()
    }
    data.update(overrides)
    return data
...
class TestGetOrCreateEntity:
    ...
    def test_get_or_create_entity_create_new(self, test_db: Session, authenticated_user_id, test_org_id, test_entity_type):
        ...
        with patch('rhesis.backend.app.utils.crud_utils.QueryBuilder') as mock_query_builder_class, \
    ...
    def test_get_or_create_entity_find_existing_by_id(self, test_db: Session, authenticated_user_id, test_org_id, test_entity_type):
        ...
        # Mock QueryBuilder and its methods
        with patch('rhesis.backend.app.utils.crud_utils.QueryBuilder') as mock_query_builder_class, \
             patch('rhesis.backend.app.utils.crud_utils._build_search_filters_for_model') as mock_build_filters:
    ...
    def test_get_or_create_entity_find_existing_by_name(self, test_db: Session, authenticated_user_id, test_org_id, test_entity_type):
...
class TestGetOrCreateSpecializedFunctions:
    ...
    def test_get_or_create_status_success(self, test_db: Session, authenticated_user_id, test_org_id):
        ...
        # Mock dependencies
        with patch('rhesis.backend.app.utils.crud_utils.get_or_create_type_lookup') as mock_get_type, \
    ...
    def test_get_or_create_status_existing(self, test_db: Session, authenticated_user_id, test_org_id):
    ...
    def test_get_or_create_type_lookup_success(self, test_db: Session, authenticated_user_id, test_org_id):
    ...
    def test_get_or_create_topic_with_all_params(self, test_db: Session, authenticated_user_id, test_org_id):
    ...
    def test_get_or_create_category_minimal_params(self, test_db: Session, authenticated_user_id, test_org_id):
        ...
        with patch('rhesis.backend.app.utils.crud_utils.get_or_create_entity') as mock_get_entity:
            ...
            # Call the function
            result = crud_utils.get_or_create_category(
                db=test_db,
                name=category_name,
                commit=True
            )
    ...
    def test_get_or_create_behavior_with_description_and_status(self, test_db: Session, authenticated_user_id, test_org_id):
        ...
        # Mock dependencies
        with patch('rhesis.backend.app.utils.crud_utils.get_or_create_status') as mock_get_status, \
             patch('rhesis.backend.app.utils.crud_utils.get_or_create_entity') as mock_get_entity:
