...
- Label and experiment_id lookups use a TTL (default 60 s).
...
class ParameterCache:
    ...
    def _key(
        ...
        *,
        ...
        return f"{project}|{label}|{experiment_id}|{version}"
    ...
    def get(
        ...
        *,
        ...
        key = self._key(
            project, label=label, experiment_id=experiment_id, version=version
        )
        with self._lock:
