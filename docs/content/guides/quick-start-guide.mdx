...
For complex conversations, use [Penelope](https://docs.rhesis.ai/docs/conversation-simulation/getting-started) to simulate multi-turn interactions.
...
- **Explore Conversation Simulation**: Learn about multi-turn testing at https://docs.rhesis.ai/docs/conversation-simulation
