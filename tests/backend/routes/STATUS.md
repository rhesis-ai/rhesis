...
12. **source** - Source management with URL validation, citations, and entity type support
13. **status** - Status management with workflow support and entity type relationships
14. **topic** - Topic management functionality
