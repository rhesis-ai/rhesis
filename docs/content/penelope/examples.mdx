...
<Callout type="default">
  **Next Steps** - Explore [Use Cases](/penelope/use-cases) for more testing
  scenarios - Learn about [Configuration](/penelope/configuration) for
  customizing behavior - Check out [Custom Tools](/penelope/custom-tools) for
  extending Penelope
</Callout>
