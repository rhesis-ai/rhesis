...
def test_model_settings_uses_system_defaults(clean_model_env):
    ...
    assert settings.generation_model == "rhesis/rhesis-managed"
    assert settings.evaluation_model == "rhesis/rhesis-managed"
    assert settings.execution_model == "rhesis/rhesis-managed"
...
def test_get_model_settings_cache_clear_allows_env_overrides(clean_model_env, monkeypatch):
    assert get_model_settings().generation_model == "rhesis/rhesis-managed"
