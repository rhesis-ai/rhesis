...
<Callout type="default">
  **Testing Framework** The frontend uses **Jest** as the test runner and **React Testing Library**
  for component testing, providing comprehensive unit testing capabilities.
</Callout>
...
<Callout type="default">
  **Test Coverage** Target coverage thresholds: **70%** for branches, functions, lines, and
  statements
</Callout>
...
<Callout type="default">
  **Resources** - [React Testing Library
  ...
  Practices](https://kentcdodds.com/blog/common-mistakes-with-react-testing-library) - [Frontend
  Testing Examples](/docs/development/frontend/testing/examples)
</Callout>
