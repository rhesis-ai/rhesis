...
| `version_info` | The version of the system behind the endpoint, as a JSON object (prompt version, model, parameters). Recorded on the test run and shown in its Configuration tab, the test runs list, and trace span details. See [Version Information](/docs/endpoints/management#version-information). |
