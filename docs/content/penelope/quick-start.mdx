...
Get started with Penelope in minutes. This guide shows you how to run your first test against a conversational AI system.
...
<Callout type="info">
  **Next:** Explore [Use Cases](/penelope/use-cases) for real-world testing scenarios, learn about [Configuration](/penelope/configuration) options for advanced setup, or understand Penelope's [Architecture](/penelope/architecture).
</Callout>
