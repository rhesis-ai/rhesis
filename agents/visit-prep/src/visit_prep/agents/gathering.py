...
from visit_prep.state import CORE_SLOTS, VisitPrepState, apply_slot_updates, missing_core_slots
...
class GatheringBrain:
    ...
    @component.output_types(state=VisitPrepState, question=str)
    ...
    def extract(self, message: str, state: VisitPrepState) -> VisitPrepState:
        messages = [
    ...
    def ask(self, state: VisitPrepState, missing: list[str] | None = None) -> str:
