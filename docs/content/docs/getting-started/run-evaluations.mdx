...
<Callout type="info">
  **Prefer working from your IDE?** The [platform skill](/docs/skills/platform) lets you run the full discover-plan-execute workflow from Cursor, Claude Code, or any compatible AI interface — no browser tab required.
</Callout>
