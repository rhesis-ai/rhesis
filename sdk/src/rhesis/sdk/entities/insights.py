...
Not a CRUD resource -- there is no single record with an id to push/pull/delete,
so this is a plain BaseModel rather than BaseEntity/BaseCollection. Construct it
with the query fields, then call get() or ids() to run it against the backend.
"""
