...
1. **Auto-Configure**: A convenient shortcut for standard OpenAI-compatible endpoints. Provide your URL and API key, and Rhesis will automatically configure the required mapping for you.
2. **Custom Mapping**: For all other APIs, you can manually use JSONPath expressions and Jinja2 templates to precisely map inputs to your API request body, and map the outputs back to Rhesis.
