...
When you import a probe, Rhesis creates one test set per probe, pre-populated with all its prompts and tagged with the corresponding category, topic, and requirement.
