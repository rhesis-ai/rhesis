...
<ThemeAwareImage
  lightSrc="/screenshots/rhesis-ai-tasks.webp"
  darkSrc="/screenshots/rhesis-ai-tasks-dark.webp"
  alt="Tasks page — work items with status and assignee, filtered by state"
/>
