...
| **Files** | (Optional) File attachments (images, PDFs, or other documents) sent alongside the prompt. See [file format filters](/platform/endpoints/single-turn#file-format-filters) for how files are mapped to provider formats. |
