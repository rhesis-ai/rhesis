...
Test sets inherit shared types, requirements, categories, topics and sources from their tests.

<ThemeAwareImage
  lightSrc="/screenshots/rhesis-ai-test-sets.webp"
  darkSrc="/screenshots/rhesis-ai-test-sets-dark.webp"
  alt="Test Sets page — each set with its requirements, categories, type, and test count"
/>
...
- **Import** tests from a file or from Garak, or generate them from the OWASP Top 10 (see below)
...
## Generating from the OWASP Top 10

Rhesis generates security test sets from the OWASP Top 10 for LLM applications or for agentic AI. You pick the risk categories and describe the system under test; the report's own section text steers the attacks. Generated tests arrive linked to the seeded OWASP judge metrics.

[Generate from OWASP →](/docs/test-sets/generate-owasp)
