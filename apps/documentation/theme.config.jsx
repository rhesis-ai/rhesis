...
export default {
  ...
  head: (
    <>
      ...
      <meta key="description" name="description" content="Rhesis: AI-powered testing and evaluation platform" />
      <meta key="og:description" name="og:description" content="Rhesis: AI-powered testing and evaluation platform" />
      ...
      <meta key="apple-mobile-web-app-title" name="apple-mobile-web-app-title" content="Rhesis Docs" />
      <link key="favicon-light" rel="icon" type="image/svg+xml" href="/logo/rhesis-logo-favicon.svg" id="favicon-light" />
      <link key="favicon-dark" rel="icon" type="image/svg+xml" href="/logo/rhesis-logo-favicon-white.svg" id="favicon-dark" media="(prefers-color-scheme: dark)" />
