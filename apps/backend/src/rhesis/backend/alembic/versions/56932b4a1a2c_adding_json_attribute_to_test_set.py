...
def upgrade() -> None:
    ...
    op.add_column("test_result", sa.Column("user_id", rhesis.backend.app.models.guid.GUID(), nullable=True))
    op.alter_column(
        "test_result",
        "test_metrics",
    ...
    op.add_column("test_set", sa.Column("user_id", rhesis.backend.app.models.guid.GUID(), nullable=True))
    op.add_column(
