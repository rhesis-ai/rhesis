...
<Callout type="default">
  **Next Steps** - Add [Endpoints](/docs/platform/endpoints) to connect your AI
  application - Create [Tests](/docs/platform/tests-generation) to validate your
  AI behavior - Organize tests into [Test Sets](/docs/platform/test-sets-runs)
  for execution
</Callout>
