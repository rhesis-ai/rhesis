...
<Callout type="warning">
  **Required:**
  ...
  Get your key from [Rhesis App](https://app.rhesis.ai) → Settings ([docs](/sdk/installation#configure-the-sdk))
...
<Callout type="default">
  **Next:** Learn about [Configuration](/penelope/configuration) options or explore how to [Extend Penelope](/penelope/extending) with custom tools and architectures.
</Callout>
