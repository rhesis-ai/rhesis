...
<CodeBlock language="json" filename="REST request_mapping">
{`{
  "query": "{{ input }}"
}`}
</CodeBlock>

<CodeBlock language="json" filename="REST request_headers">
{`{
...
<CodeBlock language="json" filename="WebSocket request_mapping">
{`{
...
<CodeBlock language="json" filename="WebSocket request_headers">
{`{
  "Upgrade": "websocket",
  "Connection": "Upgrade",
...
<CodeBlock language="json" filename="REST response_mapping">
{`{
...
<CodeBlock language="json" filename="WebSocket response_mapping">
{`{
...
<CodeBlock language="json" filename="REST Endpoint Configuration">
{`{
  "name": "Data Query API",
...
<CodeBlock language="json" filename="WebSocket Endpoint Configuration">
{`{
...
<CodeBlock language="json" filename="Validation Rules">
{`{
  "validation_rules": {
