...
| `last_annotation` | `dict` | The newest human verdict on the result, if any |
| `annotation_summary` | `dict` | One entry per annotated target. Full rows come from [`get_annotations()`](/sdk/entities/annotations) |
