...
<Callout type="default">
  **Next Steps**
  - [Execute the test set](/docs/test-sets) to run your imported Garak tests against an endpoint
  - Configure [Metrics](/docs/metrics) to add custom evaluation on top of the Garak detectors
  - Learn about [Import from File](/docs/test-sets/import-from-file) to bring in tests from CSV or Excel
</Callout>
