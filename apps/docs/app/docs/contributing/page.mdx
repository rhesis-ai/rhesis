...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
  ...
  <div>
    <h3>Documentation</h3>
    <p>Nextra-based documentation in `apps/docs/` with comprehensive guides.</p>
  </div>
  <div>
    <h3>Python SDK</h3>
...
<Callout type="default">
  **Ready to Contribute?**
  - Check out our [Development Setup Guide](/docs/development-setup)
  - Review our [Coding Standards](/docs/coding-standards)
