...
- **Targets** - Rhesis endpoints, LangChain, LangGraph, Microsoft Agent Framework, Pydantic AI, Google ADK, or any conversational system (see [Extending](/docs/tests/conversation-simulation/extending))
