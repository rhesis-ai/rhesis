...
<Callout type="default">
  **Next Steps** - Explore [Use Cases](/penelope/use-cases) for real-world testing scenarios - Learn about [Configuration](/penelope/configuration) options for advanced setup - Understand Penelope's [Architecture](/penelope/architecture)
</Callout>
