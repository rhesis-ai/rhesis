...
<Table
  ...
  rows={[
    ...
    ['`DEFAULT_LANGUAGE_MODEL_PROVIDER`', 'Default: `vertex_ai`', 'Default AI provider for test generation'],
    ['`DEFAULT_LANGUAGE_MODEL_NAME`', 'Default: `gemini-2.0-flash`', 'Default model name for generation'],
