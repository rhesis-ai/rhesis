...
<NextStepCardGrid>
  ...
  <NextStepCard
    emoji="🏗️"
    title="GCP (Terraform)"
    link="/docs/deployment/gcp-terraform"
    description="Provision your own GCP infrastructure — VPC, GKE cluster, and supporting services — with Terraform."
    linkText="View Terraform Guide →"
  />
  <NextStepCard
    emoji="☸️"
    title="Kubernetes (Helm)"
    link="/docs/deployment/kubernetes-helm"
    description="Deploy Rhesis onto a Kubernetes cluster with ArgoCD and the official Helm chart."
    linkText="View Kubernetes Guide →"
  />
</NextStepCardGrid>
