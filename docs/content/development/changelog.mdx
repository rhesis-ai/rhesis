...
This major release introduces two significant features: **Enhanced SDK Tracing** for comprehensive observability and a **New Interactive Glossary** with 50+ AI testing terms. The SDK tracing provides deep insights into your test executions with async support and smart serialization, while the glossary makes it easier for teams to understand and adopt AI testing best practices.

### Featured Capabilities

**Enhanced SDK Tracing** 🔍

The SDK now includes comprehensive tracing capabilities with improved visualization and filtering:

- **Async Support**: Full support for asynchronous operations with proper trace propagation
- **Smart Serialization**: Intelligent handling of complex objects and data structures in traces
- **Improved I/O Display**: Enhanced visualization of inputs and outputs in the UI
...
- Enhanced documentation infrastructure for glossary integration
...
- Implemented glossary term cross-referencing throughout documentation
...
- Added Chatbot Intent Recognition functionality
- Updated SDK documentation with glossary term links
