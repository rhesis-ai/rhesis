...
[REST endpoint mappings](/docs/endpoints/single-turn):
...
When your project uses **[Parameters & Experiments](/docs/parameters)**, the SDK connector automatically merges the resolved parameter snapshot into your function's keyword arguments if you specify the `parameters` list in the decorator:
