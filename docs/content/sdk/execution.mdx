...
[Platform Test Execution](/docs/test-execution) guide.
...
- **ExecutionMode.SEQUENTIAL**: Tests run one after another. Use this for endpoints with strict
  rate limits or when order matters.
...
<CodeBlock filename="execute_experiment.py" language="python">
...
[Platform Test Execution](/docs/test-execution)
</Callout>
