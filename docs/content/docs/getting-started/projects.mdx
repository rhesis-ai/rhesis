...
<ThemeAwareImage
  lightSrc="/screenshots/rhesis-ai-projects.webp"
  darkSrc="/screenshots/rhesis-ai-projects-dark.webp"
  alt="Projects page — one card per application, with its owner, status, and environment"
/>
