...
2. **Define requirements** — decide what good looks like for your application.
3. **Set up metrics** — assign judges to each requirement so responses can be scored automatically.
4. **Create tests** — write, import, or generate inputs; tag each test with a requirement.
