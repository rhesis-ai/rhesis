...
Each endpoint has a **Version Information** field in the Mapping tab. It holds free-form JSON describing your application behind this endpoint: prompt version, model, temperature, or whatever identifies a build.
...
- The **Version Information** column of the test runs list, for comparing runs at a glance.
