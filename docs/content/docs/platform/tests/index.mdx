...
See [Generation](/docs/platform/tests-generation) for detailed generation options.
...
For batch execution, add tests to [Test Sets](/docs/platform/test-sets).
...
<Callout type="default">
  **Next Steps** - Organize tests into [Test Sets](/docs/platform/test-sets) -
  Generate tests from [Knowledge](/docs/platform/knowledge) -
  View execution results in [Test Runs](/docs/platform/test-runs)
</Callout>
