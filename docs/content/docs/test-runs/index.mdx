...
<ThemeAwareImage
  ...
  alt="Test run summary — pass rate, tests executed, duration and review count, with pass rates broken down by behavior and by metric"
/>
...
<ThemeAwareImage
  ...
  alt="Metrics tab of a test result — overall performance, the behavior it belongs to, and a pass or fail verdict with a reason per metric"
/>
