...
# Distinct test IDs matching a filter, e.g. for drill-down from a chart
failed_ids = Insights(entity="test_result", filters={"test_run_ids": ["your-run-id"]}).ids(outcome="fail")`}
</CodeBlock>
