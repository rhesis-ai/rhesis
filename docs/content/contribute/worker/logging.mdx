...
# Task processing
[2024-01-15 10:30:15,234: INFO/MainProcess] Received task: rhesis.backend.jobs.execute_test[task-id-123]
[2024-01-15 10:30:15,456: INFO/ForkPoolWorker-1] Task rhesis.backend.jobs.execute_test[task-id-123] succeeded in 2.34s
[2024-01-15 10:30:16,789: INFO/MainProcess] Received task: rhesis.backend.jobs.collect_results[summary-task-456]

# Errors
[2024-01-15 10:30:20,123: ERROR/ForkPoolWorker-2] Task rhesis.backend.jobs.execute_test[task-id-789] raised unexpected: ConnectionError('Redis connection failed')
...
#### Task Errors
<CodeBlock language="bash" isTerminal={true}>
{`[ERROR/ForkPoolWorker-1] Task rhesis.backend.jobs.execute_test[...] raised unexpected: Exception('Task failed')`}
</CodeBlock>
