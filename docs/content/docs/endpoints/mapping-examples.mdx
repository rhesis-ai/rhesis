...
<Callout type="default">
  **Next Steps**
  ...
  - See [Multi-Turn Conversations](/docs/endpoints/request-mapping#multi-turn-conversations) for conversational patterns
  - See [Response Mapping](/docs/endpoints/response-mapping) for extraction details
</Callout>
