...
// Official MCP mark — native 24×24, drawn at 20×20 centered in 24×24
const { viewBox, transform } = getNavIconViewport(24, 24);

const ModelContextProtocolIcon = forwardRef<SVGSVGElement, SvgIconProps>(
  function ModelContextProtocolIcon(props, ref) {
    return (
...
ModelContextProtocolIcon.displayName = 'ModelContextProtocolIcon';

export default ModelContextProtocolIcon;
