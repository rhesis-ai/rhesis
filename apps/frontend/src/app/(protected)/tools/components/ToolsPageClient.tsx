...
interface ToolsPageClientProps {
  /** Server-fetched tools -- when present, skips the initial client fetch. */
  initialData?: Tool[];
  /** Server-fetched provider types, used until the lookup query resolves. */
  initialProviderTypes?: TypeLookup[];
}
...
export default function ToolsPageClient({
  ...
  const [tools, setTools] = useState<Tool[]>(initialData ?? []);
  const { data: providerTypes = initialProviderTypes } = useTypeLookups(
