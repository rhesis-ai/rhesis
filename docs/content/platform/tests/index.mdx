...
Goal-based conversations that test your AI system across multiple turns. Powered by [Penelope](/penelope), an autonomous testing agent that adapts its strategy based on responses. Ideal for testing realistic conversational workflows.
...
Run individual tests from the Tests page or execute multiple tests together using [Test Sets](/platform/test-sets).
