...
<Callout type="info">
  This page documents the legacy Celery chord model used before `v0.6.12`.
  Current test execution uses the async batch engine described in
  [Test Execution](/contribute/worker/test-execution).
</Callout>
...
<CodeBlock language="python" filename="chord_example.py" isTerminal={false}>
...
<CodeBlock language="python" filename="orchestration.py" isTerminal={false}>
...
<CodeBlock language="python" filename="periodic_monitoring.py" isTerminal={false}>
...
<CodeBlock language="python" filename="health_check.py" isTerminal={false}>
...
<CodeBlock language="python" filename="execute_single_test.py" isTerminal={false}>
{`@app.task(bind=True)
...
<CodeBlock language="python" filename="collect_results.py" isTerminal={false}>
{`@app.task(bind=True)
