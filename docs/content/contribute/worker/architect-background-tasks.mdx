...
- `apps/backend/src/rhesis/backend/jobs/architect/chat.py`
- `apps/backend/src/rhesis/backend/jobs/architect/monitor.py`
- `apps/backend/src/rhesis/backend/jobs/endpoint/explore.py`
- `apps/backend/src/rhesis/backend/jobs/architect/progress.py`
