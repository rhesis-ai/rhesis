...
This guide covers deploying Rhesis for production use. It covers:
...
This guide is for production environments. For quick local testing, see the [Running Locally](/deployment/running-locally) guide.
</Callout>
...
- (Optional) OAuth provider credentials for Google or GitHub sign-in
...
# Frontend URL (public origin; NextAuth derives its base URL from this)
...
**Learn More**: For technical details about the telemetry architecture, see [Telemetry System Documentation](/contribute/telemetry).
</Callout>
...
- [Backend Documentation](/contribute/backend)
- [Frontend Documentation](/contribute/frontend)
- [Worker Documentation](/contribute/worker)
- [Environment Setup Guide](/contribute/development-setup)
- [Running Locally](/deployment/running-locally) - For local development and testing
