...
function show_usage() {
  ...
  echo "  DEFAULT_LANGUAGE_MODEL_PROVIDER Default LLM provider (e.g., vertex_ai, gemini, openai)"
  echo "  DEFAULT_LANGUAGE_MODEL_NAME    Default model name for the provider"
