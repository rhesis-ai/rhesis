...
Understanding how Rhesis components work together transforms AI testing from an afterthought into a systematic practice. This guide walks through the architecture and shows how each piece fits together.
...
<Callout type="default">
  **Ready to Start?**
  Set up your first [Project](/docs/platform/projects), configure an [Endpoint](/docs/platform/endpoints), then generate [Tests](/docs/platform/tests-generation) with AI to start validating your Gen AI application.
</Callout>
