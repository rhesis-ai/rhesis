...
1. **[Development Setup](/development/contributing/development-setup)** - Set up your local development environment
2. **[Backend API Structure](/development/backend/api-structure)** - Explore the REST API architecture
3. **[Contributing Guide](/development/contributing)** - Learn how to contribute effectively
4. **[Coding Standards](/development/contributing/coding-standards)** - Follow our code quality guidelines
