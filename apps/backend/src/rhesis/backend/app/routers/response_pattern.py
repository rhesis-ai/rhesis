...
def read_response_pattern(response_pattern_id: uuid.UUID, db: Session = Depends(get_db_session)):
...
def delete_response_pattern(response_pattern_id: uuid.UUID, db: Session = Depends(get_db_session)):
