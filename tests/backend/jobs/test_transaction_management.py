...
from rhesis.backend.jobs.execution import result_processor
...
class TestTaskTransactionManagement:
    ...
    def test_task_execution_with_base_task_session_management(
        ...
        """Test that task execution works properly with BaseJob session management"""
        # This test verifies that the BaseJob.get_db_session() context manager
