...
<Callout type="default">
  **Next Steps** - Learn about [Custom Tools](/penelope/custom-tools) for extending functionality - Check out [Use Cases](/penelope/use-cases) for practical examples - Review [Configuration](/penelope/configuration) for advanced options
</Callout>
