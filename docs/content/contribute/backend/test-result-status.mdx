...
After write, the stored Pass/Fail drives stats, email, UI, and API. Do **not** rederive Pass/Fail from `test_metrics` for those paths; keep metrics for drill-down, debugging, and per-metric analytics.
...
<CodeBlock filename="example-all-pass.json" language="json">
{`{
  "test_metrics": {
    "metrics": {
...
<CodeBlock filename="example-one-fail.json" language="json">
{`{
  "test_metrics": {
    "metrics": {
      "Answer Relevancy": { "is_successful": true },
...
<CodeBlock filename="example-all-fail.json" language="json">
{`{
  "test_metrics": {
    "metrics": {
...
<CodeBlock filename="example-single-metric.json" language="json">
{`{
  "test_metrics": {
    "metrics": {
...
<CodeBlock filename="automated-test-execution.py" language="python">
...
<CodeBlock filename="api-post-test-results.py" language="python">
...
<CodeBlock filename="api-put-test-results.py" language="python">
{`# apps/backend/src/rhesis/backend/app/routers/test_result.py
...
<CodeBlock filename="email-notifications-status.py" language="python">
...
<CodeBlock filename="stats-api-status.py" language="python">
...
<CodeBlock filename="frontend-display.ts" language="typescript">
...
<CodeBlock filename="execution-error.json" language="json">
{`{
...
- [Test Result Statistics](/contribute/backend/test-result-stats) - Statistics APIs
