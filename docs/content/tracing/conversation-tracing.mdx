...
Use the Graph View when debugging complex agent interactions — it makes routing decisions and handoff sequences immediately visible. See [Multi-Agent Tracing](/tracing/multi-agent) for an example of what the graph looks like.
