...
class TestConfigGeneratorService:
    ...
    async def generate_config(
        ...
        Requirements are fetched from the database and the LLM selects which ones are relevant.
        ...
        Args:
            ...
            db: Database session for fetching requirements and project
            organization_id: Organization ID for filtering requirements and project
            project_id: Optional project ID to include project context

        Returns:
            TestConfigResponse: Generated test configuration with LLM-selected requirements and
        ...
        # Convert requirements to dict format for template
        requirement_list = [
            {"name": requirement.name, "description": requirement.description or ""}
        ...
        # Render template with user prompt, sample size, requirements, and project context
