...
Import pages from connected tools (e.g., Notion pages) to use them as sources. See [Tools documentation](/docs/tools) for more information about connecting tools.
