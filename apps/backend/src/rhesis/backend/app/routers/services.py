...
async def generate_test_config(
    ...
    JSON containing behaviors from the database (filtered by organization), and
    topics and test categories generated by the LLM.
    ...
    Returns:
        TestConfigResponse: JSON containing behaviors from database, and LLM-generated
            topics and test categories, each with name and description fields
    """
    try:
        organization_id, user_id = tenant_context
