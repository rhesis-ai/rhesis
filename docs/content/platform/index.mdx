...
<Callout type="default">
  **Try Rhesis Now:** Access the platform at [app.rhesis.ai](https://app.rhesis.ai) to start testing your LLM and agentic applications.
</Callout>
...
<Callout type="info">
  **New to Rhesis?** Start with [Core Concepts](/concepts)
...
2. **Configure [Endpoints](/platform/endpoints)** - Connect to your LLM or agentic application
