...
With your environment set up and your application connected, you are ready to run test sets. In Rhesis, a group of test cases used to evaluate an application is called a **Test Set**.
...
- [Learn more about Importing from File](/platform/test-sets/import-from-file).
...
- [Learn more about Importing from Garak](/platform/test-sets/import-from-garak).
...
For detailed information on configuring execution behavior, concurrency, and handling retries, see the [Test Execution Guide](/platform/test-execution).
