...
- [Chord Management and Monitoring](chord-management.md): Legacy guide for historical Celery chord workflows used before the async batch execution engine.
- [Chord Monitoring Quick Reference](chord-monitoring-quick-reference.md): Legacy command reference for chord monitoring workflows.
...
- **Legacy chord troubleshooting and recovery** (pre-`v0.6.12`)
...
<CodeBlock language="bash" isTerminal={true}>
{`celery -A rhesis.backend.worker.app inspect active`}
</CodeBlock>
...
### For Legacy Chord Monitoring Issues (Pre-v0.6.12)
If you're investigating historical chord-related incidents:
