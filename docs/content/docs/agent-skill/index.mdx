...
If you have a product requirements document and want a **test foundation** on Rhesis before running tests, use the [PRD Skill](/docs/agent-skill/prd). Paste your PRD with `/rhesis-prd` to create behaviors, custom metrics, tags, and generated test sets via MCP — then use this Agent Skill to execute and analyze.
