...
<ThemeAwareImage
  lightSrc="/screenshots/rhesis-ai-experiments.webp"
  darkSrc="/screenshots/rhesis-ai-experiments-dark.webp"
  alt="Experiments page — each experiment's project, visibility and latest version"
/>
