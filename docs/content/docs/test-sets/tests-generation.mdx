...
- Provide a custom configuration (requirements, topics, and categories)
...
- **Requirements**: The type of requirement the target system should meet when responding to the prompt
