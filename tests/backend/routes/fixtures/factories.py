...
class EntityFactory:
    ...
    def create(self, data: Dict[str, Any], expect_status: int = status.HTTP_200_OK) -> Dict[str, Any]:
        """
    ...
    def create_batch(self, data_list: List[Dict[str, Any]], 
                    expect_status: int = status.HTTP_200_OK) -> List[Dict[str, Any]]:
        """
...
class BehaviorFactory(EntityFactory):
    ...
    def create_with_metrics(self, behavior_data: Dict[str, Any], 
                           metric_ids: List[str]) -> Dict[str, Any]:
        """
...
class TopicFactory(EntityFactory):
    ...
    def create_hierarchy(self, parent_data: Dict[str, Any], 
                        children_data: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
