...
<Callout type="info">
  **Ready to get started?** Check out the [Installation](/penelope/installation)
  guide to set up Penelope, or jump straight to the [Quick
  Start](/penelope/quick-start) to see it in action.
</Callout>
