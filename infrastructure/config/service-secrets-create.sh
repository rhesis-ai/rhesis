...
function show_usage() {
  ...
  echo "  SCALE_TO_ZERO                              Vertex scale-to-zero (true/false)"
  echo "  MAX_REPLICA_COUNT                          Max replicas for autoscaling"
  echo "  SPOT_VM                                    Use spot VMs for inference (true/false)"
