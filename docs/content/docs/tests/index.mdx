...
<ThemeAwareImage
  ...
  alt="Tests page — prompts with their requirement, topic, category, and test type"
/>
...
Create tests manually or generate them automatically. See [Test Generation](/docs/test-sets/tests-generation) for automated generation.
...
| Test type | Fields |
| --- | --- |
| Single-turn | Prompt, category, topic, requirement, expected output, and optional file attachments |
| Multi-turn | Goal, instructions, restrictions, scenario, min turns, max turns, category, topic, requirement, and optional file attachments |
