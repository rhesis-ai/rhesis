...
class TestLookupSessionForTask:
    @patch("rhesis.backend.jobs.architect.progress._get_redis")
    def test_returns_session_id_when_key_present(self, mock_get_redis):
        from rhesis.backend.jobs.architect.progress import lookup_session_for_task
...
class TestPublishTaskProgress:
    @patch("rhesis.backend.jobs.architect.progress.publish_event")
    @patch("rhesis.backend.jobs.architect.progress.lookup_session_for_task")
...
class TestExplorationEmitsProgress:
    ...
    @patch("rhesis.backend.jobs.endpoint.explore.publish_task_progress")
...
class TestPenelopeProgressHandler:
    ...
    async def test_emits_per_turn_progress_for_user_facing_tools(self):
        from rhesis.backend.jobs.endpoint.explore import _PenelopeProgressHandler
