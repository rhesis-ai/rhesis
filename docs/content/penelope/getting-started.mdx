...
<Callout type="info">
  **Next Steps:** Explore [Examples](/penelope/examples) for real-world testing scenarios, learn about [Configuration](/penelope/configuration) options, or understand how to [Extend Penelope](/penelope/extending).
</Callout>
