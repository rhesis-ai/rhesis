...
<ThemeAwareImage
  lightSrc="/screenshots/rhesis-ai-models.webp"
  darkSrc="/screenshots/rhesis-ai-models-dark.webp"
  alt="Models page — each connected language and embedding model with its provider"
/>
...
<ThemeAwareImage
  lightSrc="/screenshots/rhesis-ai-models-add.webp"
  darkSrc="/screenshots/rhesis-ai-models-add-dark.webp"
  alt="Add model drawer — the language model provider list, with local deployments marked"
/>
