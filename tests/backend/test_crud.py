...
class TestMetricOperations:
    ...
    # ============================================================================
    # SECURITY TESTS - Cross-Tenant Access Prevention (CRITICAL)
    # ============================================================================
    ...
    def test_add_behavior_to_metric_cross_tenant_prevention(self, test_db: Session, authenticated_user_id: str):
        ...
        metric_data_org1 = CrudTestDataFactory.create_metric_data(org1_id, authenticated_user_id)
        behavior_data_org2 = CrudTestDataFactory.create_behavior_data(org2_id, authenticated_user_id)
    ...
    def test_remove_behavior_from_metric_cross_tenant_prevention(self, test_db: Session, authenticated_user_id: str):
        ...
        metric_data_org1 = CrudTestDataFactory.create_metric_data(org1_id, authenticated_user_id)
        behavior_data_org1 = CrudTestDataFactory.create_behavior_data(org1_id, authenticated_user_id)
        ...
        with pytest.raises(ValueError, match="Metric with id .* not found or not accessible"):
            crud.remove_behavior_from_metric(
                ...
                metric_id=db_metric_org1.id,
                behavior_id=db_behavior_org1.id,
                organization_id=uuid.UUID(org2_id)  # User is in org2, but metric/behavior are in org1
            )
