...
<Callout type="info">
  **New to the SDK?** Start with the [Python SDK](/docs/getting-started/sdk) guide in Getting Started for installation and basic usage.
</Callout>
...
<Callout type="default">
  **Next Steps**
  - Check the [API Reference](/docs/development/api-reference) for complete SDK documentation
  - Learn about [Contributing](/docs/development/contributing) to the SDK
  - Explore [Platform Features](/docs/platform) that complement SDK usage
</Callout>