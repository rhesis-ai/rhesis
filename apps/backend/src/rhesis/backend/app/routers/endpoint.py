...
from rhesis.backend.app.dependencies import get_tenant_context, get_db_session, get_endpoint_service
...
def read_endpoint(endpoint_id: uuid.UUID, db: Session = Depends(get_db_session)):
...
def delete_endpoint(endpoint_id: uuid.UUID, db: Session = Depends(get_db_session)):
