...
flowchart LR
    subgraph Callback-based
        ...
        LG[LangGraph] --> CB
        CB --> Spans1["ai.agent.invoke / ai.llm.invoke<br/>ai.tool.invoke / ai.retrieval<br/>spans, properly nested"]
    end
