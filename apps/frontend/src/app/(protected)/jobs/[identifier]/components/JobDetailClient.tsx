...
import type { Job, JobActivity } from '@/utils/api-client/interfaces/job';
...
interface JobDetailClientProps {
  jobId: string;
  initialJob: Job;
  /** Undefined when the server activity fetch failed -- the client fetches it. */
...
export default function JobDetailClient({
  ...
  const enabled = isAuthenticated(sessionStatus) && canRead;
  ...
  const { data: activity } = useQuery<JobActivity>({
