...
class TestLengthEnforcement:
    ...
    @pytest.mark.unit
    def test_too_short_password_is_rejected(self, monkeypatch):
    ...
    @pytest.mark.unit
    def test_too_long_password_is_rejected(self, monkeypatch):
        monkeypatch.setenv("PASSWORD_MAX_LENGTH", "20")
        monkeypatch.setenv("PASSWORD_MIN_STRENGTH_SCORE", "0")
        from rhesis.backend.app.auth.password_policy import validate_password

        with pytest.raises(HTTPException) as exc_info:
            validate_password("A" * 21)
        assert exc_info.value.status_code == 400
        assert "at most 20" in exc_info.value.detail

    @pytest.mark.unit
    def test_valid_length_passes(self, monkeypatch):
...
class TestContextWordBlocking:
    ...
    @pytest.mark.unit
    def test_email_prefix_in_password_is_rejected(self, monkeypatch):
        monkeypatch.setenv("PASSWORD_MIN_LENGTH", "8")
        monkeypatch.setenv("PASSWORD_MIN_STRENGTH_SCORE", "0")
        from rhesis.backend.app.auth.password_policy import validate_password
    ...
    @pytest.mark.unit
    def test_name_token_in_password_is_rejected(self, monkeypatch):
        monkeypatch.setenv("PASSWORD_MIN_LENGTH", "8")
        monkeypatch.setenv("PASSWORD_MIN_STRENGTH_SCORE", "0")
        from rhesis.backend.app.auth.password_policy import validate_password
    ...
    @pytest.mark.unit
    def test_service_name_in_password_is_rejected(self, monkeypatch):
        monkeypatch.setenv("PASSWORD_MIN_LENGTH", "8")
        monkeypatch.setenv("PASSWORD_MIN_STRENGTH_SCORE", "0")
        from rhesis.backend.app.auth.password_policy import validate_password
    ...
    @pytest.mark.unit
    def test_short_context_words_are_ignored(self, monkeypatch):
        monkeypatch.setenv("PASSWORD_MIN_LENGTH", "8")
        monkeypatch.setenv("PASSWORD_MIN_STRENGTH_SCORE", "0")
        from rhesis.backend.app.auth.password_policy import validate_password
    ...
    @pytest.mark.unit
    def test_no_context_passes(self, monkeypatch):
        monkeypatch.setenv("PASSWORD_MIN_LENGTH", "8")
        monkeypatch.setenv("PASSWORD_MIN_STRENGTH_SCORE", "0")
        from rhesis.backend.app.auth.password_policy import validate_password

        validate_password("xK9!mZ3@qW7$pL5#")
...
class TestStrengthScoring:
    ...
    @pytest.mark.unit
    def test_weak_password_rejected_at_score_2(self, monkeypatch):
        monkeypatch.setenv("PASSWORD_MIN_LENGTH", "8")
    ...
    @pytest.mark.unit
    def test_common_password_rejected_by_strength_check(self, monkeypatch):
    ...
    @pytest.mark.unit
    def test_strong_password_passes_at_score_2(self, monkeypatch):
        monkeypatch.setenv("PASSWORD_MIN_LENGTH", "8")
        monkeypatch.setenv("PASSWORD_MIN_STRENGTH_SCORE", "2")
        from rhesis.backend.app.auth.password_policy import validate_password

        validate_password("xK9!mZ3@qW7$pL5#vN")

    @pytest.mark.unit
    def test_strength_check_disabled_at_score_0(self, monkeypatch):
        monkeypatch.setenv("PASSWORD_MIN_LENGTH", "8")
        monkeypatch.setenv("PASSWORD_MIN_STRENGTH_SCORE", "0")
        from rhesis.backend.app.auth.password_policy import validate_password
    ...
    @pytest.mark.unit
    def test_feedback_hint_included_in_error(self, monkeypatch):
        monkeypatch.setenv("PASSWORD_MIN_LENGTH", "8")
...
class TestBreachedPasswordCheck:
    ...
    @pytest.mark.unit
    def test_breached_password_is_rejected(self, monkeypatch):
        ...
        with patch.object(password_policy, "_check_breached_sync", return_value=True):
            with pytest.raises(HTTPException) as exc_info:
                password_policy.validate_password("breachedpassword!")
            assert exc_info.value.status_code == 400
            assert "data breach" in exc_info.value.detail

    @pytest.mark.unit
    def test_non_breached_password_passes(self, monkeypatch):
        monkeypatch.setenv("PASSWORD_CHECK_BREACHED", "true")
        monkeypatch.setenv("PASSWORD_MIN_LENGTH", "8")
        monkeypatch.setenv("PASSWORD_MIN_STRENGTH_SCORE", "0")
        ...
        with patch.object(password_policy, "_check_breached_sync", return_value=False):
            password_policy.validate_password("xK9!mZ3@qW7$pL5#")

    @pytest.mark.unit
    def test_hibp_api_failure_fails_open(self, monkeypatch):
        monkeypatch.setenv("PASSWORD_CHECK_BREACHED", "true")
        monkeypatch.setenv("PASSWORD_MIN_LENGTH", "8")
        monkeypatch.setenv("PASSWORD_MIN_STRENGTH_SCORE", "0")
...
class TestFullValidationPipeline:
    ...
    @pytest.mark.unit
    def test_strong_password_passes_all_checks(self, monkeypatch):
        monkeypatch.setenv("PASSWORD_MIN_LENGTH", "12")
        monkeypatch.setenv("PASSWORD_MIN_STRENGTH_SCORE", "2")
    ...
    @pytest.mark.unit
    def test_all_whitespace_password_is_rejected(self, monkeypatch):
    ...
    @pytest.mark.unit
    def test_non_string_password_is_rejected(self, monkeypatch):
        monkeypatch.setenv("PASSWORD_MIN_STRENGTH_SCORE", "0")
        from rhesis.backend.app.auth.password_policy import validate_password
