...
For detailed instructions and troubleshooting, see the [Running Locally Guide](/deployment/quick-start).
...
For complete instructions on production-ready deployments, including setting up authentication and securing your instance, please refer to our [Self-Hosting Guide](/deployment/docker-compose).
