...
class TopicDataFactory(BaseDataFactory):
    ...
    def minimal_data(cls) -> Dict[str, Any]:
        ...
        return {"name": fake.word().title()}

    @classmethod
    def sample_data(
        cls, parent_id: Optional[str] = None, include_description: bool = True
    ) -> Dict[str, Any]:
        """
        ...
        """
        data = {"name": fake.word().title() + " " + fake.word().title()}
    ...
    def update_data(cls) -> Dict[str, Any]:
        ...
        return {"name": fake.bs().title(), "description": fake.paragraph(nb_sentences=1)}
    ...
    @classmethod
    def hierarchy_data(cls, depth: int = 2, children_per_level: int = 2) -> Dict[str, Any]:
        """
        ...
        def create_level(level: int, parent_name: str = "") -> Dict[str, Any]:
            ...
            data = {"name": name, "description": f"Description for {name}"}
...
class CategoryDataFactory(BaseDataFactory):
    ...
    def update_data(cls) -> Dict[str, Any]:
        ...
        return {"name": fake.company() + " Category", "description": fake.paragraph(nb_sentences=1)}
...
class ModelDataFactory(BaseDataFactory):
    ...
    def minimal_data(cls) -> Dict[str, Any]:
        ...
        return {
            ...
            "model_name": fake.random_element(
                elements=("gpt-4", "gpt-3.5-turbo", "claude-3", "gemini-pro")
            ),
            "endpoint": fake.url(),
            "key": fake.uuid4(),
        }
    ...
    def sample_data(cls) -> Dict[str, Any]:
        ...
        return {
            ...
            "model_name": fake.random_element(
                elements=("gpt-4", "gpt-3.5-turbo", "claude-3-sonnet", "gemini-pro", "llama-2")
            ),
    ...
    def edge_case_data(cls, case_type: str) -> Dict[str, Any]:
        ...
        if case_type == "long_name":
            ...
            return {
                ...
                "display_name": "Special Chars Corp 🏢",
                "description": fake.text(max_nb_chars=100),
                "email": fake.company_email(),
            }
        elif case_type == "unicode":
...
class ProjectDataFactory(BaseDataFactory):
    ...
    def minimal_data(cls) -> Dict[str, Any]:
        ...
        return {"name": f"{fake.catch_phrase()} Project {unique_suffix}"}
    ...
    def sample_data(cls, include_description: bool = True) -> Dict[str, Any]:
        ...
        unique_suffix = f"{int(time.time() * 1000000) % 1000000}"  # microsecond timestamp
        data = {"name": f"{fake.company()} {fake.bs().title()} Project {unique_suffix}"}
...
class PromptDataFactory(BaseDataFactory):
    ...
    def minimal_data(cls) -> Dict[str, Any]:
        ...
        return {"content": fake.sentence(nb_words=8), "language_code": "en"}
    ...
    def sample_data(
        ...
        """
        data = {"content": fake.paragraph(nb_sentences=3), "language_code": language_code}
...
class EndpointDataFactory(BaseDataFactory):
    ...
    def sample_data(cls) -> Dict[str, Any]:
        ...
        return {
            **cls.minimal_data(),
            ...
            "request_body_template": {"name": "{name}", "value": "{value}"},
            "response_format": fake.random_element(elements=("json", "xml", "text")),
            "response_mappings": {"data": "$.result", "error": "$.error"},
            "validation_rules": {"status_code": [200, 201], "response_time": {"max": 5000}},
    ...
    def update_data(cls) -> Dict[str, Any]:
        ...
        return {
            "description": fake.sentence(),
            "environment": fake.random_element(elements=("development", "staging", "production")),
            "auth": {"type": "api_key", "key": fake.sha256()},
        }
...
def generate_test_data(entity_type: str, data_type: str = "sample", **kwargs) -> Dict[str, Any]:
    """
...
class PromptTemplateDataFactory(BaseDataFactory):
    ...
    def minimal_data(cls) -> Dict[str, Any]:
        ...
        return {"content": fake.text(max_nb_chars=100), "language_code": "en"}
    ...
    def edge_case_data(cls, case_type: str) -> Dict[str, Any]:
        ...
        if case_type == "long_content":
            return {"content": fake.text(max_nb_chars=5000), "language_code": "en"}
        elif case_type == "special_chars":
            return {
                "content": "Template with émojis 🤖 and spëcial chars! @#$%^&*()",
                "language_code": "en",
            }
        elif case_type == "unicode":
            return {
...
class ResponsePatternDataFactory(BaseDataFactory):
    ...
    def minimal_data(cls) -> Dict[str, Any]:
        ...
        return {"text": fake.text(max_nb_chars=100), "behavior_id": fake.uuid4()}

    @classmethod
    def sample_data(cls, include_optional: bool = True) -> Dict[str, Any]:
        """Generate sample response pattern data"""
        data = {"text": fake.text(max_nb_chars=200), "behavior_id": fake.uuid4()}
    ...
    def update_data(cls) -> Dict[str, Any]:
        ...
        return {"text": fake.text(max_nb_chars=150), "behavior_id": fake.uuid4()}

    @classmethod
    def edge_case_data(cls, case_type: str) -> Dict[str, Any]:
        """Generate response pattern edge case data"""
        if case_type == "long_text":
            return {"text": fake.text(max_nb_chars=5000), "behavior_id": fake.uuid4()}
        elif case_type == "special_chars":
            return {
                "text": "Response with émojis 🤖 and spëcial chars! @#$%^&*()",
...
class SourceDataFactory(BaseDataFactory):
    ...
    def minimal_data(cls) -> Dict[str, Any]:
        ...
        return {"title": fake.sentence(nb_words=3).rstrip(".")}
    ...
    def edge_case_data(cls, case_type: str) -> Dict[str, Any]:
        ...
        if case_type == "long_title":
            ...
            return {
                "title": "Source with émojis 📚 and spëcial chars! @#$%^&*()",
                "description": fake.text(max_nb_chars=100),
            }
...
class StatusDataFactory(BaseDataFactory):
    ...
    def sample_data(cls, include_optional: bool = True) -> Dict[str, Any]:
        ...
        data = {"name": fake.word().title()}

        if include_optional:
            data.update({"description": fake.text(max_nb_chars=200)})
    ...
    def update_data(cls) -> Dict[str, Any]:
        ...
        return {"name": fake.word().title(), "description": fake.text(max_nb_chars=150)}
    ...
    def edge_case_data(cls, case_type: str) -> Dict[str, Any]:
        ...
        if case_type == "long_name":
            ...
            return {
                "name": "Status with émojis ⚡ and spëcial chars! @#$%^&*()",
                "description": fake.text(max_nb_chars=100),
            }
...
class RiskDataFactory(BaseDataFactory):
    ...
    def minimal_data(cls) -> Dict[str, Any]:
        ...
        return {"name": f"Risk: {fake.catch_phrase()}"}

    @classmethod
    def sample_data(cls, include_optional: bool = True) -> Dict[str, Any]:
        """Generate sample risk data"""
        data = {"name": f"Risk: {fake.catch_phrase()}"}
    ...
    def edge_case_data(cls, case_type: str) -> Dict[str, Any]:
        ...
        if case_type == "long_name":
            ...
            return {"name": long_text, "description": fake.paragraph(nb_sentences=5)}
...
class TopicDataFactory(BaseDataFactory):
    ...
    def minimal_data(cls) -> Dict[str, Any]:
        ...
        return {"name": f"Topic: {fake.catch_phrase()}"}

    @classmethod
    def sample_data(cls, include_optional: bool = True) -> Dict[str, Any]:
        """Generate sample topic data"""
        data = {"name": f"Topic: {fake.catch_phrase()}"}
    ...
    def edge_case_data(cls, case_type: str) -> Dict[str, Any]:
        ...
        if case_type == "long_name":
            ...
            return {"name": f"Topic: {fake.catch_phrase()}", "description": ""}
        elif case_type == "null_description":
            return {"name": f"Topic: {fake.catch_phrase()}", "description": None}
...
class TokenDataFactory(BaseDataFactory):
    ...
    def minimal_data(cls) -> Dict[str, Any]:
        ...
        return {"name": f"Test Token {fake.word()}"}

    @classmethod
    def sample_data(cls, include_optional: bool = True) -> Dict[str, Any]:
        """Generate sample token data - API format"""
        data = {"name": f"Test Token {fake.word()}"}

        if include_optional:
            # Add expiration in days (API format)
            data.update({"expires_in_days": 30})
    ...
    def edge_case_data(cls, case_type: str) -> Dict[str, Any]:
        ...
        if case_type == "expired_token":
            ...
            return {"name": f"API Integration - {fake.company()}", "expires_in_days": 90}
            ...
            return {"name": f"Recently Used Token {fake.word()}", "expires_in_days": 30}
        elif case_type == "recently_refreshed":
            return {"name": f"Recently Refreshed Token {fake.word()}", "expires_in_days": 30}
    ...
    def batch_data(cls, count: int, variation: bool = True) -> List[Dict[str, Any]]:
        ...
        for i in range(count):
            if variation:
                ...
                # Create similar data with incremental names
                data = {"name": f"Batch Token {i + 1}", "expires_in_days": 30}
            tokens.append(data)
...
class TypeLookupDataFactory(BaseDataFactory):
    ...
    def minimal_data(cls) -> Dict[str, Any]:
        ...
        return {"type_name": f"test_type_{fake.word()}", "type_value": f"test_value_{fake.word()}"}

    @classmethod
    def sample_data(cls, include_optional: bool = True) -> Dict[str, Any]:
        """Generate sample type lookup data"""
        data = {"type_name": f"test_type_{fake.word()}", "type_value": f"test_value_{fake.word()}"}

        if include_optional:
            data.update({"description": fake.sentence(nb_words=6)})
    ...
    def edge_case_data(cls, case_type: str) -> Dict[str, Any]:
        ...
        if case_type == "priority_levels":
            ...
            return {"type_name": type_name, "type_value": type_value, "description": description}
...
class CommentDataFactory(BaseDataFactory):
        ...
        return {
            ...
            "entity_type": fake.random_element(
                elements=[
                    ...
                    EntityType.TEST_SET.value,
                    EntityType.TEST_RUN.value,
    ...
    def update_data(cls) -> Dict[str, Any]:
        ...
        return {"content": fake.paragraph(nb_sentences=3)}
    ...
    def edge_case_data(cls, case_type: str) -> Dict[str, Any]:
        ...
        if case_type == "long_content":
            ...
            return {"content": "", "entity_id": fake.uuid4(), "entity_type": EntityType.TEST.value}
        elif case_type == "sql_injection":
            return {
    ...
    @classmethod
    def batch_data(
        cls, count: int, variation: bool = True, entity_type: str = "Test"
    ) -> List[Dict[str, Any]]:
        """
...
class TestDataFactory(BaseDataFactory):
    ...
    def update_data(cls) -> Dict[str, Any]:
        ...
        return {
            "priority": fake.random_int(min=1, max=5),
            "test_metadata": {"updated": True, "notes": fake.sentence(), "tags": fake.words(nb=2)},
        }
    ...
    def edge_case_data(cls, case_type: str) -> Dict[str, Any]:
        ...
        if case_type == "high_priority":
            return {"priority": 1, "test_metadata": {"priority_reason": "Critical security test"}}
        elif case_type == "low_priority":
            return {"priority": 5, "test_metadata": {"priority_reason": "Nice to have test"}}
            ...
            return {
                "test_metadata": {
                    ...
                    "test_data": {"inputs": fake.words(nb=5), "expected_outputs": fake.words(nb=3)},
                    "configuration": {"timeout": 30000, "retries": 3, "parallel": True},
                }
            }
...
class TagDataFactory(BaseDataFactory):
    ...
    def sample_data(cls, include_optional: bool = True) -> Dict[str, Any]:
        ...
        if include_optional:
            ...
            icons = ["🏷️", "📌", "⭐", "🔖", "📋", "🎯", "💼", "🔍", "📊", "⚡", "🎨", "🔧"]
            data.update({"icon_unicode": fake.random_element(elements=icons)})
    ...
    def update_data(cls) -> Dict[str, Any]:
        ...
        icons = ["🏷️", "📌", "⭐", "🔖", "📋", "🎯", "💼", "🔍", "📊", "⚡", "🎨", "🔧"]
        return {"name": fake.word().title(), "icon_unicode": fake.random_element(elements=icons)}

    @classmethod
    def edge_case_data(cls, case_type: str) -> Dict[str, Any]:
        """Generate tag edge case data"""
        if case_type == "long_name":
            return {"name": fake.text(max_nb_chars=200).replace("\n", " "), "icon_unicode": "📋"}
        elif case_type == "special_chars":
            return {"name": "Tag with émojis 🏷️ and spëcial chars! @#$%^&*()", "icon_unicode": "🏷️"}
        elif case_type == "unicode":
            return {"name": f"Tag 测试 тест テスト {fake.word()}", "icon_unicode": "🌍"}
    ...
    def batch_data(cls, count: int, variation: bool = True) -> List[Dict[str, Any]]:
        ...
        for i in range(count):
            if variation:
                ...
                # Create similar data with incremental names
                data = {"name": f"Tag {i + 1}", "icon_unicode": "🏷️"}
            tags.append(data)
