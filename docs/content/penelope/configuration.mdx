...
<Callout type="default">
  **Next:** Explore [Custom Tools](/penelope/custom-tools) for extending Penelope, understand the [Architecture](/penelope/architecture), or check out [Use Cases](/penelope/use-cases).
</Callout>
