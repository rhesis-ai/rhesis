...
<ThemeAwareImage
  lightSrc="/screenshots/rhesis-ai-playground.webp"
  darkSrc="/screenshots/rhesis-ai-playground-dark.webp"
  alt="Playground — a conversation with an endpoint, showing the project, endpoint and environment in the chat header"
/>
...
<ThemeAwareImage
  lightSrc="/screenshots/rhesis-ai-playground-split.webp"
  darkSrc="/screenshots/rhesis-ai-playground-split-dark.webp"
  alt="Playground in split-screen mode — the same question put to two chats side by side"
/>
...
You'll be prompted to assign a category, topic, requirement, and optional expected output before saving. Tests capture the full message context, including any attached files, so they can be replayed exactly during test execution.
