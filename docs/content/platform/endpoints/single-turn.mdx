...
<Callout type="info">
  See [Mapping Examples](/platform/endpoints/mapping-examples#file-attachments)
...
- `metadata`: Stored with the test result and available to [custom metrics](/platform/metrics#using-metadata-in-evaluation) during evaluation
