  ...
  return timelineData
    .map(item => {
      ...
      return {
        ...
        pass_rate: data.pass_rate != null ? Math.round(data.pass_rate * 10) / 10 : 0,
        total: data.total || 0,
 ...
 */
export const extractOverallData = (item: TimelineDataItem): PassFailData | null => {
 ...
 */
export const createMetricExtractor = (metricName: string) => 
