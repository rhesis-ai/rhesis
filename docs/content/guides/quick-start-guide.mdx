...
Set up your REST endpoint in the UI, or use the [Rhesis connector](https://docs.rhesis.ai/contribute/connector). Then retrieve the endpoint by ID:
...
For complex conversations, use [Penelope](https://docs.rhesis.ai/docs/tests/conversation-simulation/getting-started) to simulate multi-turn interactions.
...
- **Explore Conversation Simulation**: Learn about multi-turn testing at https://docs.rhesis.ai/docs/tests/conversation-simulation
...
For more details, see the [full self-hosting guide](/deployment/docker-compose) or [read about our Docker Compose journey](https://www.rhesis.ai/post/self-hosting-rhesis-with-docker-compose-our-journey-to-a-one-command-setup).
</Callout>
