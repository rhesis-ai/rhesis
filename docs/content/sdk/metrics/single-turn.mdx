...
| --- | --- | --- | --- | --- |
| `DeepEvalAnswerRelevancy` | Measures answer relevance to the question | No | No | [Docs](https://docs.confident-ai.com/docs/metrics-answer-relevancy) |
| `DeepEvalFaithfulness` | Checks if answer is grounded in context | Yes | No | [Docs](https://docs.confident-ai.com/docs/metrics-faithfulness) |
| `DeepEvalContextualRelevancy` | Evaluates context relevance to question | Yes | No | [Docs](https://docs.confident-ai.com/docs/metrics-contextual-relevancy) |
| `DeepEvalContextualPrecision` | Measures precision of retrieved context | Yes | Yes | [Docs](https://docs.confident-ai.com/docs/metrics-contextual-precision) |
| `DeepEvalContextualRecall` | Measures recall of retrieved context | Yes | Yes | [Docs](https://docs.confident-ai.com/docs/metrics-contextual-recall) |
| `DeepEvalBias` | Detects biased content in responses | No | No | [Docs](https://docs.confident-ai.com/docs/metrics-bias) |
| `DeepEvalToxicity` | Detects toxic content in responses | No | No | [Docs](https://docs.confident-ai.com/docs/metrics-toxicity) |
| `DeepEvalPIILeakage` | Detects personally identifiable information | No | No | [Docs](https://docs.confident-ai.com/docs/metrics-pii-leakage) |
| `DeepEvalRoleViolation` | Detects when assistant violates assigned role | No | No | [Docs](https://docs.confident-ai.com/docs/metrics-role-violation) |
| `DeepEvalMisuse` | Detects potential misuse of the system | No | No | [Docs](https://docs.confident-ai.com/docs/metrics-misuse) |
| `DeepEvalNonAdvice` | Ensures assistant doesn't give restricted advice | No | No | [Docs](https://docs.confident-ai.com/docs/metrics-non-advice) |

### DeepTeam Metrics

| Metric | Description | Requires Context | Requires Ground Truth | Reference |
| --- | --- | --- | --- | --- |
| `DeepTeamSafety` | Detects safety violations | No | No | [Docs](https://docs.confident-ai.com/docs/red-teaming-metrics-safety) |
| `DeepTeamIllegal` | Detects illegal content or requests | No | No | [Docs](https://docs.confident-ai.com/docs/red-teaming-metrics-illegal) |
