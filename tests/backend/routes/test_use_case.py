...
from .fixtures.data_factories import StatusDataFactory, UseCaseDataFactory
...
class TestUseCaseRoutes(UseCaseTestMixin, BaseEntityRouteTests):
    ...
    def test_create_use_case_healthcare_category(self, authenticated_client):
        ...
        assert has_healthcare_keyword, (
            f"Healthcare use case name '{created_use_case['name']}' should contain healthcare-related keywords"
        )
    ...
    def test_create_use_case_ecommerce_category(self, authenticated_client):
        ...
        assert (
            "recommendation" in created_use_case["name"].lower()
            or "pricing" in created_use_case["name"].lower()
            or "customer" in created_use_case["name"].lower()
            or "inventory" in created_use_case["name"].lower()
        )
    ...
    def test_create_use_case_with_empty_name(self, authenticated_client):
        ...
        invalid_data = {"name": "", "description": "Use case with empty name"}
