...
Agentic conversation tests where [Penelope](/conversation-simulation) orchestrates multi-turn interactions to achieve a specific goal. Instead of a single request-response, Penelope conducts an entire conversation strategy.
...
- [Conversation Simulation](/conversation-simulation) - Multi-turn testing agent
