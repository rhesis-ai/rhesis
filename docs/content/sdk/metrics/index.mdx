...
For full details on how trace metrics evaluation works — including the two-phase pipeline, debounce timing, project configuration, and first-turn handling — see the [Trace Metrics](/tracing/trace-metrics) documentation.
...
- [**Trace Metrics**](/tracing/trace-metrics) - Automatic evaluation on live production traces
