...
1. **[Development Setup](/contribute/contributing/development-setup)** - Set up your local development environment
2. **[Backend API Structure](/contribute/backend/api-structure)** - Explore the REST API architecture
3. **[Contributing Guide](/contribute/contributing)** - Learn how to contribute effectively
4. **[Coding Standards](/contribute/contributing/coding-standards)** - Follow our code quality guidelines
...
<Callout type="default">
  **Ready to Contribute?** Start with our [Development Setup
  Guide](/contribute/contributing/development-setup) and check out issues
