...
4. Click the **Review** icon next to the metric name
5. Select **Pass** or **Fail**
6. Optionally use `@metric-name` mentions in your comment to reference specific metrics
7. Click **Save**
...
4. Click the **Review** icon on the turn you want to assess
5. Select **Pass** or **Fail**
