...
Create tests manually or generate them automatically from behaviors and requirements. See [Generation](/docs/test-sets/tests-generation) for automated test generation.
