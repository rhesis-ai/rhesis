...
**Important**: As of version 0.5.5, all production services for the cloud version of Rhesis are now hosted in European data centers, ensuring data sovereignty and compliance with European data protection regulations.

### Featured Capabilities

**Enhanced SDK Tracing**

The SDK now includes comprehensive tracing capabilities that provide deep visibility into your application under test (the target) and its inner workings:
