...
This major release introduces comprehensive documentation enhancements with a new interactive glossary feature containing 50+ AI testing terms. The glossary provides detailed explanations of key concepts from configuration basics to advanced testing patterns, making it easier for teams to understand and adopt AI testing best practices.
...
- Improved API documentation with glossary term references
...
- Enhanced documentation navigation with glossary integration

### SDK Highlights
- Updated SDK documentation with glossary term links
- Improved code examples with glossary context
