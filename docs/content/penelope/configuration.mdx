...
<Callout type="default">
  **Next:** Learn how to [Extend Penelope](/penelope/extending) with custom tools and architecture details, or explore [Examples](/penelope/examples) for practical use cases.
</Callout>
