...
Zero-config tracing for LangChain, LangGraph, Microsoft Agent Framework, Pydantic AI, Google ADK, and Haystack applications. It traces LLM calls, tool invocations, and chain executions without modifying your code.
