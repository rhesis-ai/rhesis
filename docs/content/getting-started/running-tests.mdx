...
**Using the UI:**
You can use the Rhesis Platform to generate tests interactively. Provide a description of your application, and Rhesis will synthesize relevant test scenarios.
...
## 3. Adversarial Security Testing (Garak)
