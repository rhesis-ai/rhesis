...
- **Targets** - Rhesis endpoints, LangChain, LangGraph, Microsoft Agent Framework, Pydantic AI, Google ADK, Haystack, or any conversational system (see [Extending](/docs/tests/conversation-simulation/extending))
