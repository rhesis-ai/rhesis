...
Learn more about creating custom endpoints in the [Endpoints documentation](/platform/endpoints).
...
<Callout type="default">
  **Next Steps** - Try the [interactive demo](/demo) to chat with Rosalind in
  your browser - Learn about [custom endpoints](/platform/endpoints) for
  your own AI services - Explore [test
  generation](/platform/tests-generation) to validate your AI applications
  - Set up [metrics](/platform/metrics) to measure response quality
</Callout>
