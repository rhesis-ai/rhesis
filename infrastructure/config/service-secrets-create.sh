...
function show_usage() {
  ...
  echo "  PERSPECTIVE_API_KEY           Google Perspective API key for toxicity detection"
  ...
  echo "  MACHINE_TYPE                               Machine type"
  echo "  ACCELERATOR_TYPE                           Accelerator type"
  echo "  ACCELERATOR_COUNT                          Accelerator count"
  ...
  echo "  TF_VAR_BACKEND_DOMAIN                      Backend domain"
  echo "  TF_VAR_FRONTEND_DOMAIN                     Frontend domain"
  echo "  TF_VAR_WORKER_DOMAIN                       Worker domain"
  echo "  TF_VAR_POLYPHEMUS_DOMAIN                   Polyphemus domain"
  echo "  TF_VAR_CHATBOT_DOMAIN                      Chatbot domain"
  echo "  TF_VAR_BACKEND_IMAGE                       Backend image"
  echo "  TF_VAR_FRONTEND_IMAGE                      Frontend image"
  echo "  TF_VAR_WORKER_IMAGE                        Worker image"
  echo "  TF_VAR_POLYPHEMUS_IMAGE                    Polyphemus image"
  echo "  TF_VAR_CHATBOT_IMAGE                       Chatbot image"
  echo "  TF_VAR_ENABLE_LOAD_BALANCERS              Enable load balancers"
  echo ""
...
SERVICE_VARS=(
  ...
  "TF_VAR_WORKER_DOMAIN"
  "TF_VAR_POLYPHEMUS_DOMAIN"
  "TF_VAR_CHATBOT_DOMAIN"
  "TF_VAR_BACKEND_IMAGE"
  "TF_VAR_FRONTEND_IMAGE"
  "TF_VAR_WORKER_IMAGE"
  "TF_VAR_POLYPHEMUS_IMAGE"
  "TF_VAR_CHATBOT_IMAGE"
  "TF_VAR_ENABLE_LOAD_BALANCERS"
)
