...
| [**Requirements → test foundation**](/docs/agent-skill/requirements) | Paste a Product Requirements Document (PRD), product spec, or other requirements; create behaviors, metrics, tags, and test sets |
...
[`skills/rhesis/`](https://github.com/rhesis-ai/rhesis/tree/main/skills/rhesis) — skill instructions and reference docs (`references/prd/` for requirements design guides).
