...
Entities are the SDK's interface to the Rhesis platform. They provide typed Python objects that map directly to platform resources, enabling you to create, read, update, and delete data programmatically.

<Callout type="info">
  **Prerequisites**: Ensure you have [configured the SDK](/sdk/installation) with your API key before using entities.
</Callout>
