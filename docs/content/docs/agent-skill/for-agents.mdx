...
3. **Term lookup:** `https://docs.rhesis.ai/glossary/<term-id>.md` (e.g. `requirement`, `metric-scope`, `test-set`)
...
- **Requirement vs metric** — Requirement = what should happen. Metric = how you score it.
- **Category/topic vs requirement** — Categories and topics organize tests; they do not replace requirements or metrics.
- **PRD section title vs requirement** — "Security" is not a requirement. Split numbered requirements into testable expectations.
