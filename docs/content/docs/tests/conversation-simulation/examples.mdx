...
See [Core Concepts](/conversation-simulation#core-concepts) for detailed explanation of how restrictions work with goals, instructions, and scenarios.
...
See [Extending](/conversation-simulation/extending#custom-tools) for detailed tool creation guide.
...
<Callout type="default">
  **Next:** Learn about [Configuration](/conversation-simulation/configuration) options or
  explore how to [Extend](/conversation-simulation/extending) Penelope with custom tools and
  architectures.
</Callout>
