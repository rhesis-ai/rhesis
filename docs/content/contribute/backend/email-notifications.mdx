...
<CodeBlock filename="email-templates.py" language="python">
{`from rhesis.backend.notifications.email.template_service import EmailTemplate
...
<CodeBlock filename="custom-subject-template.py" language="python">
{`@email_notification(
...
<CodeBlock filename="task-with-email.py" language="python">
{`from rhesis.backend.tasks.base import BaseTask, with_tenant_context, email_notification
from rhesis.backend.notifications.email.template_service import EmailTemplate
from rhesis.backend.worker import app
...
<CodeBlock filename="legacy-email-task.py" language="python">
...
<CodeBlock filename="chord-example.py" language="python">
...
<CodeBlock filename="task-integration.py" language="python">
{`from rhesis.backend.tasks.base import BaseTask, with_tenant_context, email_notification
from rhesis.backend.notifications.email.template_service import EmailTemplate
from rhesis.backend.worker import app
