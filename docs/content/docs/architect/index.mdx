...
- **Design** a complete test suite with requirements, metrics, and test sets — reusing what already exists on the platform
...
- **Analyze** any existing test run with requirement and metric breakdowns
- **Read what people flagged** — human annotations on results and traces, which outrank the automated verdict when the two disagree
- **Diagnose with traces** — open what your application actually did to produce a response, when the metrics say a test failed but not why
- **Do direct operations** — update a metric, link a requirement, list test sets — without going through the full planning flow

<ThemeAwareImage
  lightSrc="/screenshots/rhesis-ai-architect-chat.webp"
  darkSrc="/screenshots/rhesis-ai-architect-chat-dark.webp"
  alt="Architect chat — what the endpoint exploration found, the proposed plan, and the plan progress bar"
/>
