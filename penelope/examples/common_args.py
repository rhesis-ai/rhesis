...
Examples:
  ...
  uv run python {example_name} -e your-endpoint-id --max-iterations 20
    ...
    parser.add_argument("--endpoint-id", "-e", required=True, help="Rhesis endpoint ID to test")
    ...
    parser.add_argument(
        "--max-iterations", type=int, default=10, help="Maximum number of iterations (default: 10)"
    )
