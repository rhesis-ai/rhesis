...
**Using the UI:**
You can use the Rhesis Platform to generate tests interactively. Navigate to the **Generation** menu item, provide a description of your application, and Rhesis will synthesize relevant test scenarios.
