...
Human **reviews** on each test result sit beside automated `test_metrics`: multiple reviewers, metric- or whole-test scope, and CRUD via the API. Nested `metadata` holds rollups for quick list views.

## Design goals

Separate machine vs human judgements, support several rounds, keep reviewer and status IDs traceable, and refresh top-level metadata when reviews change.
...
<CodeBlock filename="test-reviews-schema.json" language="json">
{`{
  "metadata": {
...
<CodeBlock filename="test-result-model.py" language="python">
...
<CodeBlock filename="review-schemas.py" language="python">
{`# Review schemas
...
<CodeBlock filename="create-review-request.json" language="json">
{`{
...
<CodeBlock filename="create-review-response.json" language="json">
{`{
...
<CodeBlock filename="update-review-request.json" language="json">
{`{
...
<CodeBlock filename="update-review-response.json" language="json">
{`{
  "review_id": "c370e2d7-f526-41c4-94f0-a6f25735a9b9",
  "status": {
    "status_id": "735acfa0-cca2-48a1-bb90-ba10b16f1cdb",
...
<CodeBlock filename="delete-review-response.json" language="json">
{`{
...
<CodeBlock filename="get-test-result-response.json" language="json">
{`{
