...
[Kubernetes (Helm)](/deployment/kubernetes-helm#automate-public-dns) guide.
...
list, not the whole zone. The [Kubernetes (Helm)](/deployment/kubernetes-helm#add-internal-dns)
