...
class TestCurrentDatabaseIntegration:
    ...
    def test_get_metrics_list(self, test_db, test_org_id, test_metric_numeric, test_metric_categorical):
    ...
    def test_metric_with_behavior_relationship(self, test_db, test_behavior_with_metrics, test_metric_numeric):
    ...
    def test_query_metrics_by_organization(self, test_db, test_org_id, test_metric_numeric, secondary_org_id):
