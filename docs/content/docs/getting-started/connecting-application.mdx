...
<ThemeAwareImage
  lightSrc="/screenshots/rhesis-ai-endpoints-create.webp"
  darkSrc="/screenshots/rhesis-ai-endpoints-create-dark.webp"
  alt="Create endpoint drawer — the Overview tab, naming the endpoint and its project"
/>
