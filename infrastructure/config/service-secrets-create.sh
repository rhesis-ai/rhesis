...
function show_usage() {
  ...
  echo "  CELERY_ARCHITECT_CONCURRENCY  Architect worker concurrency (number of threads)"
  ...
  echo "  NEXT_PUBLIC_ONBOARDING_VIDEO_URL  Onboarding video URL for frontend"
