...
| Pasted PRD / FRs / requirements | [Requirements workflow](/docs/agent-skill/requirements) |
...
Fictional requirements plan shape: [`use-case-bracketfeld.md`](https://github.com/rhesis-ai/rhesis/blob/main/skills/rhesis/references/use-case-bracketfeld.md)
