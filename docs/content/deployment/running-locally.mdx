...
This local setup is great for testing and development. When you're ready to deploy to production, see the [Self-Hosting Guide](/deployment/self-hosting) for proper security configuration and production deployment.
</Callout>
