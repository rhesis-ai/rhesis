...
7. Inspect the per-metric tooltip on failing rows to read the evaluator's reasoning — this gives you the language to describe the failure in a requirement or a bug report.
