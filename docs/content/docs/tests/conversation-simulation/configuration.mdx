...
<Callout type="default">
  **Next:** Learn how to [Extend](/conversation-simulation/extending) Penelope with custom
  tools and architecture details, or explore [Examples](/conversation-simulation/examples) for
  practical use cases.
</Callout>
