...
The worker service processes background tasks using Celery. Create a `.env` file in `apps/worker/` or configure environment variables for the worker container.
