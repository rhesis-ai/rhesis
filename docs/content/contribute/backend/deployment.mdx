...
APP_DB_USER=your-app-user
APP_DB_PASS=your-app-password
# Optional: set ADMIN_DB_USER/ADMIN_DB_PASS for a separate migration role
...
{`gcloud run deploy rhesis-backend \
  ...
  --set-env-vars "DB_HOST=/cloudsql/project-id:region:instance"`}
</CodeBlock>
