...
Create Jira issues directly from tasks. First, [set up a Jira MCP connection](/docs/mcp#add-a-mcp-connection-to-jira-or-confluence) with a configured project key. Once connected, use the **Create Jira Issue** button on any task to automatically create a linked issue in your Atlassian workspace.
...
<Callout type="default">
  **Next Steps** - Create tasks from [Test Results](/docs/test-results) - Link tasks to [Tests](/docs/tests) - Organize work by [Projects](/docs/projects)
</Callout>
