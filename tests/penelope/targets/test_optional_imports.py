...
langchain, langgraph, pydantic-ai, the agent-framework, and haystack packages
...
HaystackTarget are imported unconditionally from targets/__init__.py, so none of
