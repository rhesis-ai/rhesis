...
| `list_queries` | after seeding 2000 tests: latency and statement count of the paginated list endpoints, plus `EXPLAIN (ANALYZE, BUFFERS)` of the prompt list query |
