...
def upgrade() -> None:
    ...
    op.alter_column('dimension', 'name',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.alter_column('endpoint', 'auth_token',
               existing_type=sa.TEXT(),
               type_=rhesis.backend.app.utils.encryption.EncryptedString(),
               existing_nullable=True)
    op.alter_column('endpoint', 'client_secret',
               existing_type=sa.TEXT(),
               type_=rhesis.backend.app.utils.encryption.EncryptedString(),
               existing_nullable=True)
    op.alter_column('endpoint', 'last_token',
               existing_type=sa.TEXT(),
               type_=rhesis.backend.app.utils.encryption.EncryptedString(),
               existing_nullable=True)
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_unique_constraint('uq_tagged_item_assignment', 'tagged_item', ['tag_id', 'entity_id', 'entity_type', 'organization_id'])
