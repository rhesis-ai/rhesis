...
description: Set up your Rhesis environment, connect your LLM application, and run your first automated evaluations in minutes.
keywords: [getting started, AI testing setup, LLM evaluation quickstart, connect LLM application]
---
...
<NextStepCardGrid>
  ...
  <NextStepCard
    ...
    link="/docs/tests/adversarial-testing"
  ...
  <NextStepCard
    ...
    link="/docs/tests/conversation-simulation"
...
<NextStepCardGrid>
  <NextStepCard
    emoji="📚"
    title="Core Concepts"
    description="Understand the fundamental concepts of testing LLM applications with Rhesis."
    link="/docs/concepts"
