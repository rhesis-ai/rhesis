...
The Test Results page gives an overview of the test results across test runs and across projects. Analyze aggregated [Test Run](/platform/test-runs) performance across multiple executions.
