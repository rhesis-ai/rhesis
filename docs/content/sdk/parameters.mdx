...
<Callout type="default">
  For the conceptual overview (schemas, versions, environments, visibility), see [Parameters](/docs/parameters) and [Experiments](/docs/experiments). This page covers the SDK API.
</Callout>
...
# By environment (default when omitted)
...
Pass `experiment_id`, `version`, or `environment` to `TestSet.execute()` to pin a test run to a specific configuration:
