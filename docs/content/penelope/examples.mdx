...
<Callout type="warning">
  **Required before running examples:** 1. **RHESIS_API_KEY**: Set your Rhesis
  API key as an environment variable ```bash export
  RHESIS_API_KEY="rh-your-api-key" ``` Get your API key from [Rhesis
  App](https://app.rhesis.ai) → Settings 2. **Rhesis Endpoint ID**: Get this
  from your Rhesis dashboard 📚 See the [SDK Authentication
  Guide](/sdk/installation#configure-the-sdk) for details.
</Callout>
...
<Callout type="default">
  **Next Steps:**
  ...
  Explore [Use Cases](/penelope/use-cases) for more testing scenarios, learn about [Configuration](/penelope/configuration) for customizing behavior, or check out [Custom Tools](/penelope/custom-tools) for extending Penelope.
</Callout>
