...
class TopicDataFactory(BaseDataFactory):
    ...
    @classmethod
    def hierarchy_data(
        cls, depth: int = 2, children_per_level: int = 2
    ) -> Dict[str, Any]:
        """
        ...
        def create_level(level: int, parent_name: str = "") -> Dict[str, Any]:
            ...
            name = (
                f"{parent_name} Level {level}" if parent_name else f"Root Level {level}"
            )
...
class MetricDataFactory(BaseDataFactory):
    ...
    def minimal_data(cls) -> Dict[str, Any]:
        ...
        return {
            ...
            "score_type": fake.random_element(
                elements=("numeric", "categorical", "binary")
            ),
        }
    ...
    def sample_data(cls) -> Dict[str, Any]:
        ...
        return {
            ...
            "threshold_operator": fake.random_element(
                elements=("=", "<", ">", "<=", ">=", "!=")
            ),
...
class OrganizationDataFactory(BaseDataFactory):
    ...
    def update_data(cls) -> Dict[str, Any]:
        ...
        return {
            "name": fake.company()
            + " Updated",  # Optional for updates, but good to test
...
class ProjectDataFactory(BaseDataFactory):
    ...
    def minimal_data(cls) -> Dict[str, Any]:
        ...
        unique_suffix = (
            f"{int(time.time() * 1000000) % 1000000}"  # microsecond timestamp
        )
...
def generate_test_data(
    entity_type: str, data_type: str = "sample", **kwargs
) -> Dict[str, Any]:
    """
        ...
        if case_type == "long_name":
            ...
            return {
                ...
                "industry": fake.random_element(
                    elements=["Legacy Systems", "Outdated Technology"]
                ),
...
class TypeLookupDataFactory(BaseDataFactory):
    ...
    def edge_case_data(cls, case_type: str) -> Dict[str, Any]:
        ...
        if case_type == "priority_levels":
            ...
            type_name, type_value, description = fake.random_element(
                elements=priority_types
            )
            return {
                "type_name": type_name,
...
class TagDataFactory(BaseDataFactory):
    ...
    def edge_case_data(cls, case_type: str) -> Dict[str, Any]:
        ...
        if case_type == "long_name":
            ...
            return {
                "name": "Tag with émojis 🏷️ and spëcial chars! @#$%^&*()",
                "icon_unicode": "🏷️",
            }
        elif case_type == "unicode":
