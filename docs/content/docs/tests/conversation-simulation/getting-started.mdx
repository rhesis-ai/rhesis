...
<Callout type="info">
  **Next Steps:** Explore [Examples](/conversation-simulation/examples) for real-world testing
  scenarios, learn about [Configuration](/conversation-simulation/configuration) options, or
  understand how to [Extend](/conversation-simulation/extending) Penelope.
</Callout>
