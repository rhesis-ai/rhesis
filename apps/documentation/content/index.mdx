...
<div className="flex flex-col sm:flex-row gap-4 py-8">
  <a
    ...
    className="btn-rhesis-primary inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md"
  >
    Get Started →
  </a>
  <a
    href="/getting-started/concepts"
    className="btn-rhesis-secondary inline-flex items-center justify-center px-6 py-3 text-base font-medium rounded-md"
  >
    Learn Core Concepts →
  </a>
</div>
