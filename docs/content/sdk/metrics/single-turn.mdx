...
| `ToxicCommentModel` | Detects failures to refuse harmful or sensitive requests | API-based | [Docs](https://reference.garak.ai/en/stable/garak.detectors.unsafe_content.html) |
