...
- **Auto-instrumentation**: `auto_instrument("google_adk")` translates the spans Google ADK already
  ...
  I/O, and agent-to-agent handoffs for both of ADK's multi-agent mechanisms. Multi-turn ADK sessions
  group in the Conversation tab automatically. See [Google ADK](/docs/tracing/google-adk).
