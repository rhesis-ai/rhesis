...
class TestCreateTestRun:
    ...
    @patch("rhesis.backend.jobs.execution.run.schemas")
    @patch("rhesis.backend.jobs.execution.run.test_run_crud")
    @patch("rhesis.backend.jobs.execution.run.get_or_create_status")
