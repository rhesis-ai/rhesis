...
|--------|----------|----------|
| `test_result` | `requirement`, `requirement_id`, `category`, `category_id`, `topic`, `topic_id`, `test_run`, `status`, `year`, `month` | `count`, `passed`, `failed`, `pass_rate` |
| `metric` | `metric_name`, `requirement_id`, `year`, `month` | `count`, `passed`, `failed`, `pass_rate`, `automated_passed`, `automated_failed`, `human_annotation_count` |
| `test_run` | `status`, `test_set`, `executor`, `year`, `month` | `count`, `passed`, `failed`, `pass_rate` |
| `test` | `requirement`, `requirement_id`, `category`, `category_id`, `topic`, `topic_id`, `is_unrun`, `year`, `month` | `count`, `unrun_count`, `run_count`, `passed`, `failed`, `pass_rate` |
...
| Entity | filters |
|--------|---------|
| `test_result` | `test_run_ids`, `requirement_ids`, `category_ids`, `topic_ids`, `status_ids`, `test_ids`, `test_type_ids`, `user_ids`, `assignee_ids`, `owner_ids`, `prompt_ids`, `test_set_ids`, `tags` |
| `metric` | `test_run_ids`, `requirement_ids`, `test_ids`, `metric_names` |
| `test_run` | `test_run_ids`, `user_ids`, `endpoint_ids`, `test_set_ids`, `status_names` |
| `test` | `requirement_ids`, `category_ids`, `topic_ids`, `status_ids`, `test_ids`, `test_type_ids`, `user_ids`, `assignee_ids`, `owner_ids`, `prompt_ids`, `test_set_ids`, `tags` |
